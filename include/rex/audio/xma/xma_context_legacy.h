...
// [XMA fix] XmaContextLegacy is a direct extraction of the old XmaContext
// decoding logic. Nothing about the algorithm changed — it was moved here so
// the new Canary-ported decoder (XmaContextNew) could be added alongside it
// without breaking existing behavior. Selectable at runtime via xma_decoder=old.
