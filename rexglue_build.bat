...
:: 2. Check for and delete the "bin" folder
if exist "bin" (
    echo [!] Found existing "bin" folder. Deleting...
    rmdir /s /q "bin"
    echo [+] "bin" folder cleared.
) else (
    echo [.] No "bin" folder found. Proceeding with a fresh build.
)

echo.

:: 3. Configure CMake with preset
