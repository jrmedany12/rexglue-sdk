...
// [XMA fix] XmaContextLegacy is a straight extraction of the original XmaContext
// decoding code. The algorithm is unchanged from the old single-class version —
// it was moved here so XmaContextNew could be added as an alternative without
// breaking anything. If something worked before this rewrite it will still work
// here. Select it at runtime with xma_decoder=old.
